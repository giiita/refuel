...
case class JsEntry(key: JsString, value: JsonVal) extends JsonVal {
   ...
   * @param c delimiter
   */
  override def approvalSyntax(c: Char): Unit = throw UnsupportedOperation("Operations other than composition are not allowed for incomplete Json entries.")
   ...
   * @return
   */
  override def pour(b: StringBuffer): Unit = throw UnsupportedOperation("Operations other than composition are not allowed for incomplete Json entries.")
   ...
   * @return
   */
  override def ++(js: JsonVal): JsonVal = throw UnsupportedOperation("Operations other than composition are not allowed for incomplete Json entries.")
   ...
   * @return
   */
  override def named(key: String): JsonVal = throw UnsupportedOperation("Operations other than composition are not allowed for incomplete Json entries.")
}
