...
class TupleCodecsImplTest extends AsyncWordSpec with Matchers with DiagrammedAssertions with JsContext {
  ...
  implicit val JTuple2Codec = CaseClassCodec.from[JTuple2]
  implicit val JTuple3Codec = CaseClassCodec.from[JTuple3]
  implicit val JTuple4Codec = CaseClassCodec.from[JTuple4]
  implicit val JTuple5Codec = CaseClassCodec.from[JTuple5]
  implicit val JTuple6Codec = CaseClassCodec.from[JTuple6]
  implicit val JTuple7Codec = CaseClassCodec.from[JTuple7]
  implicit val JTuple8Codec = CaseClassCodec.from[JTuple8]
  implicit val JTuple9Codec = CaseClassCodec.from[JTuple9]
  implicit val JTuple10Codec = CaseClassCodec.from[JTuple10]
  implicit val JTuple11Codec = CaseClassCodec.from[JTuple11]
  implicit val JTuple12Codec = CaseClassCodec.from[JTuple12]
  implicit val JTuple13Codec = CaseClassCodec.from[JTuple13]
  implicit val JTuple14Codec = CaseClassCodec.from[JTuple14]
  implicit val JTuple15Codec = CaseClassCodec.from[JTuple15]
  implicit val JTuple16Codec = CaseClassCodec.from[JTuple16]
  implicit val JTuple17Codec = CaseClassCodec.from[JTuple17]
  implicit val JTuple18Codec = CaseClassCodec.from[JTuple18]
  implicit val JTuple19Codec = CaseClassCodec.from[JTuple19]
  implicit val JTuple20Codec = CaseClassCodec.from[JTuple20]
  implicit val JTuple21Codec = CaseClassCodec.from[JTuple21]
  implicit val JTuple22Codec = CaseClassCodec.from[JTuple22]
