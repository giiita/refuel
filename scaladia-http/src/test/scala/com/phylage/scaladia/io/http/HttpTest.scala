package com.phylage.scaladia.io.http
...
import HttpTest.TestEntity.Jokes
  ...
  "Http io test" should {
    ...
    "inner class can not deserialize" in {
      http[GET]("http://api.icndb.com/jokes/random")
        ...
        .map(x => fail(x))
        .recover {
          case e => e.getMessage startsWith "Cannot construct instance of `com.phylage.scaladia.io.http.HttpTest$" shouldBe true
        }
    }
    "deserializing" in {
      http[GET]("http://api.icndb.com/jokes/random")
