...
import com.github.giiita.io.http.Http.setting
import com.github.giiita.io.http.setting.HttpSetting
...
object Http extends Injector {
  ...
  private[http] val setting = inject[HttpSetting].recover {
    case _ => new HttpSetting()
  }
