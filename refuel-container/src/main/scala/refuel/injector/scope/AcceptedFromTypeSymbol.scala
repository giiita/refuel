...
/**
  ...
  */
private[refuel] case class AcceptedFromTypeSymbol[T](value: T, priority: Int = Int.MaxValue, x: Type, acceptedFrom: Vector[Class[_]], c: Container) extends IndexedTagSymbol[T](x) {
  /**
