...
abstract class SymbolRestriction[T](val key: scala.Symbol, val value: T, val priority: InjectionPriority) {
  ...
  /**
    ...
    * @return
    */
  final def accepted[X](requestFrom: X)(implicit x: TypedAcceptContext[X]): Boolean = {
