...
import com.phylage.scaladia.injector.{AutoInject, InjectOnce, Injector}
...
class ClassSymbolInjectionTest extends AsyncWordSpec with Matchers with DiagrammedAssertions with Injector {
  "confirm" should {
    ...
    "Many tag type" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_B._
    ...
    "Auto Injectable class symbol inject become a different instance" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_I._
      bind[I] should not be bind[I]
    }

    "If primary constructor has parameters, the parameters is confirmed" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_G._
      val result = bind[G]
  ...
  "inject" should {
    "Effective injection" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_C._
      inject[Effectives].value shouldBe "I am B"
    }
    "Auto injectable class vs module" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_D._
      inject[D].v shouldBe "DImplModule"
    }
    "class symbol inject with flush container" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_E._
      val a = inject[E]._provide
      val b = inject[E]._provide
      a shouldBe b
    }
    "class symbol inject no flush" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_F._
  ...
  "shade" should {
    "Auto Injectable class symbol inject become a different instance in shade" in {
      import com.phylage.scaladia.ClassSymbolInjectionTest.TEST_H._
